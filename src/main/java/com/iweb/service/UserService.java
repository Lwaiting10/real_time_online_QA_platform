...
public interface UserService {
     ...
     * @return 更新是否成功
     */
    boolean update(User user, HttpServletRequest req);

    boolean updatePassword(User user, String password);

    boolean updateAdminPassword(Admin admin, String password);

    boolean updateAdminUsername(Admin admin, String username);

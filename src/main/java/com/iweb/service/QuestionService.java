...
public interface QuestionService {
    ...
    List<QuestionDTO> queryPassQuestionDTO(String title, String category);

    List<QuestionDTO> queryQuestionDTOListByStatus(String status);

    QuestionDTO queryQuestionDTOByQuestionId(String questionId);
